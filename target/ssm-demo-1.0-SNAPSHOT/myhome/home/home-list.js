...
function doLoadEditPage() {
    if($(this).hasClass("btn-update")){
        ...
        title= "修改房间信息,id="+idValue;
        url= "doFindObjectById.do?id="+idValue;
    }
...
debugger
    ...
    for(var i in result){
        ...
        var tds = "<td><input type='checkbox' name='checkId' value=' "+result[i].id+" '></td>"+
            ...
            "<td>"+result[i].hourse_pasword+"</td>"+
            "<td>"+result[i].room_password+"</td>"+
            "<td class='td-manage'>" +
            "<a title='修改' class='btn-update'><i class='layui-icon'>&#xe642;</i></a>" +
            "</td>";
        //2.4、将td添加到tr中
        tr.append(tds);
        //2.5、将tr追加到tbody中
