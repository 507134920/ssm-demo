...
<head>
    ...
    <script type="text/javascript" src="${basePath}/myhome/tenant/tenant-list.js"></script>
...
<div class="x-body">
    <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so" id="queryFormId">
            ...
            <input type="text" name="phone"  placeholder="请输入租客手机号" autocomplete="off" class="layui-input" id="searchPhoone">
    ...
    <xblock>
        ...
        <button class="layui-btn layui-btn-block"><i class="layui-icon"></i>批量拉黑</button>
        <button class="layui-btn btn-add"><i class="layui-icon"></i>添加</button>
    </xblock>
